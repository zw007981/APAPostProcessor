...
#include "core/MINCO_THETA_S/minco_theta_s_steer_padding.h"
...
TEST(MincoThetaSSteerPaddingTest, SmallDthetaWindowIsLegalized) {
...
TEST(MincoThetaSSteerPaddingTest, LargeDthetaWindowIsSkipped) {
...
// 低于 0.05 rad。
TEST(MincoThetaSSteerPaddingTest, JunctionKinkIsTaperedUnderLongDt) {
...
TEST(MincoThetaSSteerPaddingTest, SinglePointBoundaryWindowIsLegalized) {
