...
MincoThetaSEsdfPenalty::MincoThetaSEsdfPenalty(const ESDFMap& esdf_map,
...
MincoThetaSEsdfPoseCost MincoThetaSEsdfPenalty::evaluate(double x, double y,
                                         double theta) const {
...
void MincoThetaSEsdfPenalty::accumulateCircle(const Eigen::Vector2d& local_center,
