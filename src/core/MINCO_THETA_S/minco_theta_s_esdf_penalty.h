...
// 单时刻位姿的双重碰撞惩罚评估结果
struct MincoThetaSEsdfPoseCost {
...
class MincoThetaSEsdfPenalty {
   ...
   protected:
    ...
    void accumulateCircle(const Eigen::Vector2d& local_center, double cos_theta,
                          ...
                          MincoThetaSEsdfPoseCost& result) const;
